...
Java_com_freezy_NativeBridge_getNativeString(JNIEnv* env, jclass, jint id) {
    if (id == 1) {
        ...
        unsigned char s[] = {0x9A, 0x01, 0x5D, 0xC5, 0x6E, 0x07, 0xBD, 0x21, 0xD3, 0x5C, 0x68, 0x84, 0x4A, 0x39, 0x9D, 0x17, 0xA9, 0x28, 0x76, 0xE2, 0x4D, 0x20, 0x9D, 0x1E, 0xB2, 0x36, 0x09, 0x89, 0x7C, 0x4B, 0xAD, 0x36, 0x83, 0x51, 0x04, 0xC9, 0x2C, 0x07, 0xBD, 0x3C, 0x94, 0x05, 0x41, 0x84, 0x21, 0x46, 0xB4, 0x37, 0x9D, 0x16, 0x5D, 0xCC, 0x2C, 0x5B, 0xE2, 0x64, 0xC3, 0x51, 0x04, 0xCE, 0x2C, 0x2A, 0x9B, 0x11, 0xB6, 0x21, 0x7D, 0x00};
        xor_cipher(s, sizeof(s) - 1);
        return env->NewStringUTF((char*)s);
    }
    else if (id == 111) {
        unsigned char s[] = {0x9A, 0x01, 0x5D, 0xC5, 0x6E, 0x07, 0xBD, 0x21, 0xD3, 0x5C, 0x68, 0x84, 0x4A, 0x39, 0x9D, 0x17, 0xA9, 0x28, 0x76, 0xE2, 0x4D, 0x20, 0x9D, 0x1E, 0xB2, 0x36, 0x09, 0x89, 0x7C, 0x4B, 0xAD, 0x36, 0x83, 0x51, 0x04, 0xC9, 0x2C, 0x07, 0xBD, 0x3C, 0x94, 0x05, 0x41, 0x84, 0x21, 0x46, 0xB4, 0x37, 0x9D, 0x16, 0x5D, 0xCC, 0x2C, 0x5D, 0xE9, 0x68, 0xC2, 0x44, 0x19, 0x94, 0x2C, 0x46, 0xB5, 0x72, 0x9F, 0x18, 0x44, 0xCD, 0x78, 0x4B, 0xF5, 0x7F, 0x9F, 0x18, 0x44, 0xCD, 0x78, 0x4B, 0xEB, 0x7D, 0x80, 0x14, 0x4A, 0x84, 0x21, 0x46, 0xB4, 0x3B, 0x9E, 0x18, 0x5D, 0x89, 0x6E, 0x1E, 0xAA, 0x21, 0x87, 0x51, 0x18, 0x84, 0x21, 0x01, 0xF8, 0x13, 0xB0, 0x32, 0x6C, 0xF4, 0x58, 0x00};
        xor_cipher(s, sizeof(s) - 1);
        return env->NewStringUTF((char*)s);
    }
    else if (id == 112) {
