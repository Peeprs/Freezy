...
object NativeBridge {
    ...
    const val S245 = 245
    const val S246 = 246
    const val STRING_LOGIN_SUBTITLE = 247
    const val STRING_BTN_GET_KEY = 248
    const val STRING_OFFICIAL_CHANNELS = 249
    const val STRING_BADGE_SECURE_VERIF = 250
    const val STRING_TITLE_VALIDATING = 251
    const val STRING_STATUS_CHECKING_ACCESS = 252
    const val STRING_BTN_RETURN_LOGIN = 253
    const val STRING_BADGE_IMPORTANT_NOTICE = 254
    const val STRING_DISCLAIMER_HEADER = 255
    const val STRING_DISCLAIMER_SUBTITLE = 256
    const val STRING_BTN_ACCEPT_CONTINUE = 257
    const val STRING_BTN_EXIT_DECLINE = 258
    const val STRING_BADGE_UPDATE_REQUIRED = 259
    const val STRING_UPDATE_SUBTITLE = 260
    const val STRING_UPDATE_HINT = 261
    const val STRING_BTN_OPEN_WHATSAPP = 262
    const val STRING_TIKTOK_TITLE = 263
    const val STRING_TIKTOK_SUBTITLE = 264
    const val STRING_BADGE_ACCESS_AUTHORIZED = 265
    const val STRING_TITLE_LICENSE_VALID = 266
    const val STRING_STATUS_VALID_DESC = 267
    const val STRING_BADGE_EXPIRED = 268
    const val STRING_TITLE_EXPIRED = 269
    const val STRING_STATUS_EXPIRED_DESC = 270
    const val STRING_BADGE_NET_ERROR = 271
    const val STRING_TITLE_NET_ERROR = 272
    const val STRING_STATUS_NET_ERROR_DESC = 273
    const val STRING_BADGE_MAINTENANCE = 274
    const val STRING_TITLE_MAINTENANCE = 275
    const val STRING_STATUS_MAINTENANCE_DESC = 276
    const val STRING_BADGE_DENIED = 277
    const val STRING_TITLE_DENIED = 278
    const val STRING_STATUS_DENIED_DESC = 279
    const val STRING_DESC_WA = 280
    const val STRING_DESC_TT = 281
}
